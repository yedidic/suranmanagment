const texts = [
  {
    ...
    html: `לוודא ששי הוסיף לפלייליסט שירים להפעלה בתחילת או בסוף המעגל.<br><br>

בתחילת המעגל או בבדיקת הסאונד לוודא שהמיק הנכון של שי הוא הפעיל.<br>

<b>- להוסיף ספוטלייט לשי/סוראן</b><br>
<b>- לוודא שעצרתי את שיתוף הסאונד של המחשב</b><br><b>- ביטול אפשרות המשתתפים להשתיק את עצמם בתחילת המעגל:</b><br><br>
