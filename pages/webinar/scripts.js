const texts = [
  {
    ...
    <li>🎙️ בתחילת המעגל או בבדיקת הסאונד לוודא שהמיק הנכון של שי הוא הפעיל.</li>
<li>🔦 להוסיף ספוטלייט לשי/סוראן</li>
<li>✏️ אחרי שסוראן נכנס לעדכן את השם של שי ל "Suran" ובסוף המעגל לעדכן ל"Shay Garbarz" (כמו בתחילת המעגל). </li>
<li>🔇 לוודא שעצרתי את שיתוף הסאונד של המחשב</li>
</ul>
</b><br><b>🚫 ביטול אפשרות המשתתפים לבטל השתקה בתחילת המעגל:<br>
...
<b>In Chat</b> ➡️ <i class="fas fa-check-square"></i>  <span style="color:red;">CHECK: </span> Participants can chat with ↘️ "Host and co-hosts"<br><br>
</div>🔊 בפתיחה ובסגירה, אחרי שסוראן אומר שלום או ערב טוב, ללחוץ בתוך "משתתפים" (Participants):<br>
...
כשמישהו רוצה לשאול, יש לעשות לו:<br><i>"Ask to unmute"</i> (בקשה לביטול השתקה)<br>
ואם הווידאו שלו סגור ורוצים לעודד אותו לפתוח:<br>
<i>"Ask to start video"</i> (בקשה להפעלת מצלמה)<br><br>
<b><i>🔦 ספוטלייט - רלוונטי רק כשהמצלמה של השואל פועלת</i></b><br><br>

<i>"Add Spotlight"</i> (הוספת ספוטלייט)<br>
לשואל החדש ואז
<br>
<i>"Remove Spotlight"</i> (הסרת ספוטלייט)<br>
...
<b>👁️ הערה לגבי וידאו:</b><br>

עוד נקודה קטנה היא שלפעמים כדאי להעיף מבט בכל הווידאואים. כבר היה לנו פעם אחת עירום. פעם אחת מפשעה. פעם אחת מישהו פולה פרעושים לחתול. ואינספור אוכלים ומדברים בטלפון וכו׳.. במקרים חריגים אני סוגר להם וידאו.
`,
    icon: "fa-users-cog",
    nonCopyable: true,
  },
  {
    ...
    value: `כשסוראן יברך אותנו לשלום, ניתן יהיה לפתוח מיקרופון באופן עצמאי ולענות, ואחר כך - סִגרו אותו בבקשה. 🙏`,
    icon: "fa-door-open",
  },
  {
    label: "הסבר טכני על הרמת יד לשאלות",
    value: `כשסוראן יזמין אותנו לשאול או לשתף במהלך המעגל - תוכלו לבקש רשות דיבור על ידי הרמת "יד וירטואלית" ✋

💻 במחשב - לחצו על כפתור "תגובות" (Reactions) בסרגל הכלים התחתון, ובחרו "הרמת יד" (Raise Hand).
📱 בטלפון הנייד - לחצו על "עוד" (More) בסרגל התחתון, ובחרו "הרמת יד" (Raise Hand).

הרמתם יד כדי לשאול? השאירו את חלון הצ׳אט פתוח כדי שנוכל להודיע לכם מתי תורכם לשאול 💬

🎥 נשמח שתשאלו כשמצלמתכם פועלת, אך ניתן לשאול גם בקולכם בלבד כשהמצלמה סגורה. לבחירתכם.

☝️ כדי לאפשר לכולם לשאול או לשתף - בבקשה הסתפקו בשאלה אחת בלבד (במקרה שכל השואלים יסיימו לשאול, נזמין את מי שרוצה לשאול גם שנית).

💡 שימו לב, אם בחרתם לדבר בוובינר, קולכם יישמע בהקלטה שתפורסם בעתיד. זאת, אלא אם תבקשו להסיר את שאלתכם בפנייה למייל:
info@suran.co.il
`,
    icon: "fa-hand-paper",
  },
